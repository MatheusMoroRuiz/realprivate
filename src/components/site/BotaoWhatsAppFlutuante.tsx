...
export function BotaoWhatsAppFlutuante() {
  return (
    <a
      ...
      className="fixed right-5 bottom-5 z-60 inline-flex size-[62px] items-center justify-center rounded-full bg-ink-500 text-white shadow-[0_16px_34px_-12px_rgb(5_32_32/0.7)] transition-[background-color,transform] duration-200 hover:bg-ink-700 motion-safe:hover:-translate-y-0.5 sm:right-7 sm:bottom-7"
    >
