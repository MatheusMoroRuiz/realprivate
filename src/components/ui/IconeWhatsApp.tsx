 ...
 *
 * É o glifo oficial do WhatsApp (balão de conversa + fone), não um ícone
 * genérico de "ligar" — reconhecível mesmo sozinho, sem o texto "WhatsApp"
 * ao lado (como no botão flutuante).
 */
